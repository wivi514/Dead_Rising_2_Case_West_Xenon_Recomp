...
// `vs_recipes.bin` carries those patches (docs/part102-no-popin-plan.md). This pass reads `data/shaders/deadrisingepilogue-ps.big`, decodes each
...
// CW_NO_VS_RECIPES=1 is the same-binary control arm.
