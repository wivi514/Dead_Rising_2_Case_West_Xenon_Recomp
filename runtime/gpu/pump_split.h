...
// single-producer / single-consumer queue that a second thread (D, `cw-draw`) executes in
...
//
// OFF unless CW_PUMP_SPLIT=1 (this part's arm; the shipped default is the one-thread
