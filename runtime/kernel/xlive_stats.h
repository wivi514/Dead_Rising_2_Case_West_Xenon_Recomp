...
//
// ON ONLY WHEN THE TITLE IS TOLD IT IS ONLINE. CW_XLIVE_ONLINE=1 is what makes
...
// Starts the completion thread. Called from CwXlive_Start; a no-op unless
// CW_XLIVE_ONLINE=1.
