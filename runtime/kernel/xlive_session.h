...
//
// OFF BY DEFAULT. CW_XLIVE_COOP=1 turns it on. Without it every message below
...
// Called from CwXlive_Start, and a no-op unless CW_XLIVE_COOP=1.
...
// than only when two people sit down to play. Off unless CW_XLIVE_COOP_TEST=1.
