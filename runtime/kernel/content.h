...
// unless CW_SAVE_DIR says otherwise.
...
// the offline default profile, which keeps "default". A CW_SAVE_DIR override
// wins over both.
...
// Where cw_settings.txt lives: the game folder above the per-profile save dir (a
// second profile must not reset display settings), or the CW_SAVE_DIR override
