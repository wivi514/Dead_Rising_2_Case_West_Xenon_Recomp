...
//
// WHY THIS EXISTS (part 106). The GPU split (CW_VK_GPU_PASSES) says WHERE the device's
...
// shader (CW_VK_NULL_PS=1), this module leaves the vertex shader, the vertex input, the
...
// shaders cost. CW_VK_SCISSOR_1PX=1 is the complementary arm (everything but the
