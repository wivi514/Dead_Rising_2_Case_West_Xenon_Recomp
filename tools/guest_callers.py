...
# Case West's `.text`. This read 0x873564 — Case Zero's — when the file was copied here
# on 2026-08-15; see docs/bootstrap-2026-08-15.md §7 for why a constant that is wrong in
# the safe direction reports a clean run. This tool only walks `.text` (it is a caller
# census, and BINK is a self-contained statically linked decoder that nothing else calls
# into), so a single constant is honest here — but it is stated as this title's.
TEXT_SIZE = 0x87BC54
