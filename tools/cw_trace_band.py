...
# Imported from Case Zero tools/part80_trace_band.py (2026-08-29) for the AutoChuck
# soak; the CW_VK_FRAME_TRACE format is the same code, imported with parts 72-81.
