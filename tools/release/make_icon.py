...
an opaque binary nobody can vouch for. Dev-only (PIL); the PNG it writes is what ships.
    ...
    python3 tools/release/make_icon.py            -> tools/release/icon/cw_runtime.png
"""
import os
import sys
...
OUT = os.path.join(HERE, "icon", "cw_runtime.png")
SIZE = 256
...
def main():
    ...
    # the "0" of Case West as a thin ring under the letters
