...
def main():
    ...
    ap.add_argument("--config", default="config/CaseWest.toml")
    ap.add_argument("--switch-tables", default="config/CaseWest_switch_tables.toml",
