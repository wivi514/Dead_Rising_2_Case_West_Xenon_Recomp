...
# the target any more) and `RES=1920x1080 CW_NO_WINDOW=1`. The part-109 target is the
...
#
# NO CW_VK_PROFILE. The phase profiler costs 4.2-5.0 ms a frame on this box (§4.1) and
