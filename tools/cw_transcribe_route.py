#!/usr/bin/env python3
"""Turn a recorded operator route into a CW_FAKE_PRESS_SEQ recipe.
...
The operator's answer was to play the route themselves once, with `CW_INPUT_TRACE=1`
...
if not samples:
    sys.exit("** no [input] lines matched -- was CW_INPUT_TRACE=1 set, and is this the "
